...
class DeepSeekAdapter(BaseLLMAdapter):
    ...
    async def list_models(self):
        return [
            ModelInfo(id="deepseek-chat", name="DeepSeek Chat V3", provider=self.provider, configured=self.is_configured),
            ModelInfo(id="deepseek-reasoner", name="DeepSeek Reasoner R1", provider=self.provider, configured=self.is_configured),
        ]
